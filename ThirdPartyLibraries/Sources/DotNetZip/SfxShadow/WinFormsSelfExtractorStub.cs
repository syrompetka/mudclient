...
//
// last saved (in emacs): 
// Time-stamp: <2009-October-27 06:24:01>
//
// ------------------------------------------------------------------
//
...
namespace Ionic.Zip
{
    ...
    public partial class WinFormsSelfExtractorStub : Form
    {
        ...
        private void Form_Shown(object sender, EventArgs e)
        {
            ...
            // test if we are running in design/test mode or not.
            if (litmus.StartsWith("@@") && litmus.EndsWith("QUIET"))
                return; // not really a self-extractor
