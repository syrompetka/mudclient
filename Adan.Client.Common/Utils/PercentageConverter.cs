// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PercentageConverter.cs" company="Adamand MUD">
...
namespace Adan.Client.Common.Utils
{
    ...
    /// <summary>
    /// <see cref="IValueConverter"/> to convert double value to percent of specified parameter.
    /// </summary>
    public class PercentageConverter : IValueConverter
    {
        ...
        public object Convert([CanBeNull] object value, [NotNull] Type targetType, [CanBeNull] object parameter, [NotNull] CultureInfo culture)
        {
            ...
            return System.Convert.ToDouble(value, culture) * System.Convert.ToDouble(parameter, culture) / 100.0f;
        }
