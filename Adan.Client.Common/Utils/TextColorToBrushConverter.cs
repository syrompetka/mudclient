// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TextColorToBrushConverter.cs" company="Adamand MUD">
...
namespace Adan.Client.Common.Utils
{
    ...
    /// <summary>
    /// A <see cref="IValueConverter"/> implementation to convert <see cref="TextColor"/> to <see cref="Brush"/> for databinding.
    /// </summary>
    ...
    public class TextColorToBrushConverter : IValueConverter
    {
        ...
        public object Convert([NotNull] object value, [NotNull] Type targetType, [CanBeNull] object parameter, [NotNull] CultureInfo culture)
        {
            ...
            return ThemeManager.Instance.ActiveTheme.GetBrushByTextColor((TextColor)value, false);
        }
